...
(cffi:defctype %sndfile::size-t :unsigned-long-long)
...
(cffi:defcstruct (%sndfile::info :size 24)
                 (%sndfile::frames %sndfile::count-t :offset 0)
                 (%sndfile::samplerate :int :offset 4)
                 (%sndfile::channels :int :offset 8)
                 (%sndfile::format :int :offset 12)
                 (%sndfile::sections :int :offset 16)
                 (%sndfile::seekable :int :offset 20))
...
(cffi:defcstruct (%sndfile::|C:@SA@SF-EMBED-FILE-INFO| :size 8)
                 (%sndfile::offset %sndfile::count-t :offset 0)
                 (%sndfile::length %sndfile::count-t :offset 4))
